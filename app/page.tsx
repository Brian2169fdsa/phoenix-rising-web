      ...
      <div className="container hero__inner">
        <div data-fade>
          ...
          <div className="hero__cta">
            ...
            <Button variant="secondary" size="lg" href="/booking">Get a Free Quote</Button>
          </div>
        ...
        <div data-fade>
          <GlassSlot ratio="4/5" src="/assets/shot-home-hero.jpg" label="Sparkling Arizona glass"
          ...
          {SERVICES.map((s) => (
            <Card className="svc" key={s.title} interactive data-fade>
              ...
              <ul className="svc__list">
                {s.list.map((item) => <li key={item}><Icon name="check" size={16} strokeWidth={2.4} /> {item}</li>)}
              </ul>
              <div className="svc__foot">
                ...
                <a href="/services" style={{ display: 'inline-flex', alignItems: 'center', gap: 4, fontWeight: 600, fontSize: 14 }}>Details <Icon name="chevron-right" size={15} /></a>
              </div>
            </Card>
          ))}
        </div>
        <div className="section__foot-cta">
          <Button variant="secondary" href="/services" rightIcon={<Icon name="arrow-right" size={17} />}>See all six services</Button>
        </div>
      </div>
    </section>
  );
      ...
      <div className="container split">
        <div data-fade>
          ...
          <div style={{ marginTop: 28 }}>
            <Button variant="primary" href="/gallery" rightIcon={chevron}>View the gallery</Button>
          </div>
        </div>
        <div data-fade>
          <BeforeAfter beforeSrc="/assets/window-dirty.jpg" afterSrc="/assets/window-clean.jpg" />
        </div>
      </div>
    </section>
  );
  ...
  return (
    <section className="section section--alt">
      <div className="container">
        ...
        <div className="section__foot-cta">
          <Button variant="secondary" href="/reviews" rightIcon={<Icon name="arrow-right" size={17} />}>Read more reviews</Button>
        </div>
      </div>
    </section>
  );
...
function AreaPins() {
  const pins: [number, number][] = [[30, 38], [52, 30], [60, 52], [44, 60], [70, 64], [38, 72], [22, 56], [78, 44]];
  return (
    ...
    <section className="section">
      <div className="container split">
        ...
        <div data-fade>
          ...
          <div style={{ marginTop: 28 }}>
            <Button variant="primary" href="/service-area" rightIcon={chevron}>Check your address</Button>
          </div>
        </div>
      </div>
    </section>
