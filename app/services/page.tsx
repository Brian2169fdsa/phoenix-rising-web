    ...
    <div className={'svcrow' + (flip ? ' svcrow--flip' : '')} id={s.id} data-fade>
      <div>
        ...
        <div className="svcrow__foot">
          <Button variant="primary" href="/booking" rightIcon={chevron}>Book this service</Button>
      ...
      <div className="svcrow__media">
        <GlassSlot ratio="4/3" src={'/assets/shot-svc-' + s.id + '.jpg'} label={s.name}
    ...
    <div className="site">
      ...
      <section className="pagehead">
        <div className="container pagehead__inner">
          <div className="crumbs"><a href="/">Home</a> / <span>Services</span></div>
          ...
          <div className="grid grid-3">
            {SERVICES.map((s) => (
              <a key={s.id} href={'#' + s.id} className="opt" data-fade>
                ...
                <span>
                  <span className="opt__t">{s.name.split(' / ')[0].replace(' Window Cleaning', '').replace(' Cleaning', '')}</span>
                  <span className="opt__d">{s.from === 'Custom' || s.from === 'Quote' ? 'By quote' : 'From ' + s.from}</span>
                </span>
              </a>
            ))}
          </div>
        ...
        <div className="container">
          <div className="ctaband glint glint--animate" data-fade>
            ...
            <div className="ctaband__cta">
              <Button variant="primary" size="lg" href="/booking" rightIcon={chevron}>Get a Free Quote</Button>
            </div>
          </div>
        </div>
      </section>
