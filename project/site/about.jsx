...
const { Button, Card, Badge, TrustBadge } = window.PhoenixRisingDesignSystem_61b068;
...
function AboutPage() {
  return (
    <div className="site">
      <SiteHeader active="about.html" />
      <section className="pagehead">
        <div className="container pagehead__inner">
          <div className="crumbs"><a href="index.html">Home</a> / <span>About</span></div>
      ...
      <section className="section">
        <div className="container split">
          <div data-fade>
            ...
            <div className="svcrow__foot"><Button variant="primary" href="booking.html" rightIcon={chevron}>Work with our crew</Button></div>
          </div>
          <div data-fade><GlassSlot id="about-story" ratio="4/5" label="Drop a crew photo" badge={<Badge tone="primary">Est. 2025</Badge>} /></div>
        </div>
      </section>
              ...
              <Card key={t.n} data-fade style={{ padding: 20 }}>
                <div style={{ aspectRatio: "1", borderRadius: "var(--r-md)", overflow: "hidden", border: "1px solid var(--chrome-300)" }}>
                  {t.img
                    ...
                    : <image-slot id={"team-" + i} shape="rounded" radius="0" placeholder={"Drop " + t.n.split(" ")[0] + "'s photo"} style={{ width: "100%", height: "100%", display: "block" }}></image-slot>}
                </div>
      ...
      <section className="section section--tight">
        <div className="container">
          <div className="ctaband glint glint--animate" data-fade>
            <div><h2>Phoenix-strong, since day one.</h2><p>Put a decade of streak-free obsession to work on your glass.</p></div>
