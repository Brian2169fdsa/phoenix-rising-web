const { Icon, SiteHeader, SiteFooter, Eyebrow, GlassSlot, mount } = window;
    ...
    <div className="site">
      ...
      <section className="section" style={{ paddingBottom: 0 }}>
        <div className="container article">
          <div className="crumbs" style={{ color: "var(--cool-gray)" }}><a href="blog.html">Resources</a> / <span>Dust Season</span></div>
          <span style={{ display: "flex", gap: 10, alignItems: "center", marginTop: 18 }}><Badge tone="primary">Maintenance</Badge><span className="postcard__meta"><Icon name="clock" size={14} /> 6 min read · May 2026</span></span>
      ...
      <section className="section" style={{ paddingTop: 36 }}>
        <div className="container article">
          <GlassSlot id="post-hero" ratio="16/8" src="assets/shot-g4.jpg" label="Dusty vs. clean glass" badge={<Badge tone="primary">Dust season</Badge>} />
          ...
          <div className="panel" style={{ marginTop: 36, display: "flex", gap: 20, alignItems: "center", flexWrap: "wrap", justifyContent: "space-between" }}>
            <div><h3 className="feature__t" style={{ fontSize: 18 }}>Not sure what cadence you need?</h3><p className="muted" style={{ marginTop: 6, fontSize: 14.5 }}>Tell us about your home and we'll recommend one, free.</p></div>
            <Button variant="primary" href="booking.html" rightIcon={chevron}>Get a Free Quote</Button>
          </div>
        </div>
      </section>
      ...
      <section className="section section--alt section--tight">
        <div className="container">
          ...
          <div className="grid grid-3" style={{ marginTop: 28 }}>
            {[["Hard Water", "Hard-Water Spots on Arizona Glass", "assets/shot-g1.jpg"], ["Solar", "Solar Panel Cleaning in the Desert", "assets/shot-svc-solar.jpg"], ["Seasonal", "A Seasonal Window-Maintenance Guide", "assets/shot-g6.jpg"]].map(([c, t, img], i) => (
              <a key={i} href="blog.html"><Card className="postcard" interactive data-fade>
                <div className="postcard__media"><img src={img} alt={t} loading="lazy" decoding="async" style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }} /></div>
                <div className="postcard__body"><span className="postcard__cat">{c}</span><h3 className="postcard__t">{t}</h3></div>
              </Card></a>
            ))}
          </div>
        </div>
