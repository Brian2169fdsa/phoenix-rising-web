    ...
    <div className="site">
      ...
      <section className="pagehead">
        <div className="container pagehead__inner" style={{ padding: "56px 0" }}>
          <div className="crumbs"><a href="index.html">Home</a> / <span>Terms</span></div>
          <Eyebrow>Legal</Eyebrow>
          <h1 className="pagehead__title" style={{ fontSize: "clamp(34px,4.5vw,48px)" }}>Terms of <span className="accent">Service</span></h1>
