...
function GalleryPage() {
  ...
  return (
    <div className="site">
      <SiteHeader active="gallery.html" />
      <section className="pagehead">
        <div className="container pagehead__inner">
          <div className="crumbs"><a href="index.html">Home</a> / <span>Gallery</span></div>
      ...
      <section className="section">
        <div className="container">
          ...
          <div className="grid grid-2">
            {items.map((it) => (
              <Card key={it.id} className="postcard" interactive data-fade>
                <div className="postcard__media">
                  <img src={"assets/shot-" + it.id + ".jpg"} alt={it.title} loading="lazy" decoding="async" style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }} />
                </div>
      ...
      <section className="section section--tight">
        <div className="container">
          <div className="ctaband glint glint--animate" data-fade>
            <div><h2>Want your windows on this wall?</h2><p>Book a clean and we'll show you the before-and-after in person.</p></div>
